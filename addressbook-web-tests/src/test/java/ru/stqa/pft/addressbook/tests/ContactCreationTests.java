...
public class ContactCreationTests extends TestBase{
    ...
    public void ContactCreationTests() {
        ...
        fillContactCreationForm(new ContactData("username", "middlename", "lastname", "nickname", "title", "company", "address", "homePhone", "mobilePhone", "workPhone", "faxPhone", "email", "email2", "email3", "homepage", "1980", "2000", "address2", "home2", "notes"));
        sendContactForm();
        gotoHomePage();
    }
